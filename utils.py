...
env_vars = ["VENMO_ACCESS_TOKEN", "TELEGRAM_CHAT_ID", "TELEGRAM_BOT_TOKEN", "I_FRIEND_ID", "J_FRIEND_ID", "K_FRIEND_ID", "L_FRIEND_ID", "S_FRIEND_ID", "Y_FRIEND_ID", "P_FRIEND_ID", "MONTH_STR"]
